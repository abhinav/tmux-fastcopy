...
//
//	mockgen -destination mock_widget_test.go -package ui github.com/abhinav/tmux-fastcopy/internal/ui Widget
//
...
func (mr *MockWidgetMockRecorder) Draw(arg0 any) *gomock.Call {
...
func (mr *MockWidgetMockRecorder) HandleEvent(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
